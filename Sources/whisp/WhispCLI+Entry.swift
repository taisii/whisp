...
extension WhispCLI {
    ...
    static func printUsage() {
        ...
        print("usage: whisp --benchmark-stt-cases [/path/to/manual_test_cases.jsonl] [--stt-provider \(STTProviderCatalog.allowedProviderRawValueText())] [--stt rest|stream] [--chunk-ms N] [--benchmark-workers N] [--realtime|--no-realtime] [--limit N] [--min-audio-seconds N] [--no-cache]")
